#Tic Tac Toe (Advanced using pygame), download pygame and numpy
import sys 
import pygame 
import numpy as np 
...
def minimax(minimax_board, depth, is_maximizing): 
    #assigning route where its most likely to win 
...
while True: 
    ...
    #If you want to win, change the min to max and vice-versa 